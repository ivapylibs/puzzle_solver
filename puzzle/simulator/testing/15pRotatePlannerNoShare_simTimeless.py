#!/usr/bin/python3
# ============================ 15pRotatePlannerNoShare_simTimeless ===========================
#
# @brief    Test script with command from the planner & simTimeless simulator & the simulator does not share
# # #           the board with the planner. (15p img)
#
# ============================ 15pRotatePlannerNoShare_simTimeless ===========================

#
# @file     15pRotatePlannerNoShare_simTimeless.py
#
...
#
theSim = SimTimeLess(theSolver.current, theHand, thePlanner, thePlannerHand, shareFlag=False)
theSim.display()
