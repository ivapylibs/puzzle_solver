#!/usr/bin/python3
# ============================ realSolverManualCalibrate2_basic ===========================
#
...
#
# @file     realSolverManualCalibrate2_basic.py
#
...
for i in range(1,N+1):
    if i==1:
        thePrevImage = cv2.imread(cpath + f'/../../testing/data/puzzle_real_sample_black_hard2/sol_cali_mea_{i-1}.png')
        thePrevImage = cv2.cvtColor(thePrevImage, cv2.COLOR_BGR2RGB)

    else:
        thePrevImage = theCurImage

    theCurImage = cv2.imread(cpath + f'/../../testing/data/puzzle_real_sample_black_hard2/sol_cali_mea_{i}.png')
...
theGridSol = gridded(theCalibrated)

# theGridSol = gridded(theCalibrated,theParams=paramGrid(areaThresholdLower=1000, reorder=True,
#                                                                 pieceConstructor=regular))

theImageMea = cv2.imread(cpath + '/../../testing/data/puzzle_real_sample_black_hard2/sol_cali_mea_25.png')
