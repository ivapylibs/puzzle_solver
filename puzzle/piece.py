...
class Template:
    ...
    def rotatePiece(self, theta):
        ...
        # RELATIVE TO THE ORIGINAL ONE.  INSTANTIATE A NEW PIECE
        ...
        #print("This rotatePiece code will fail.  Please correct it.\n")
        #
        # 2024/10/31 - PAV Corrected. Will not fail. But left legacy code.
        ...
        rotPiece = Template.buildFromMaskAndImage(rMa, rIm, cLoc, rLoc, \
