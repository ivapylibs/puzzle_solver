...
#================================ calib04save ================================
## @file
# @brief    Save Calibrated puzzle test script.
#
...
#==[3] Apply, create solution, and save.
#
theDet.process(theMask)
theLabels = label(theDet.getState().x)

solPuzzle = puzzle.Calibrate()
solPuzzle.process(theImage, theLabels)

solPuzzle.save("calib04save.hdf5")
